...
<main role="main" class="flex-shrink-0">
    <div class="container">
        <h1 class="mt-5">Monitoring File</h1>
        <p class="lead">Ini adalah aplikasi untuk memonitoring file pada directory yang dituju dengan menjalankan file python yang telah kami sediakan sebagai proses utama monitoring file</p>
    </div>
</main>
